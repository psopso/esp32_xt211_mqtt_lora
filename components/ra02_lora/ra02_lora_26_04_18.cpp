...
//    this->write_reg(0x0D, 0x80); // TX Base pointer  //TX ptr
//    this->write_reg(0x0F, 0x80); // FIFO pointer    //RX base
    
    this->write_reg(0x0E, 0x80); // RegFifoTxBaseAddr: Nastavíme začátek TX na 0x80   //TX base
